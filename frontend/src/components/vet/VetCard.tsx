...
const VetCard = ({ user }) => {
  return (
    <div className="rounded overflow-hidden shadow border border-light border-1 rounded-3 bg-light-subtle card-custom" style={{width: "500px"}}>
      <img
        style={{ height: "320px" }}
        ...
        <div className="text-gray-700 text-base">
          <div className="row justify-content-between">
            ...
            <div className="mt-1">
              ...
              <div className="fw-medium">{user?.services.map((service,index) => (
...
const VetUpdateCard = ({ editedUser, handleChange }) => {
  return (
...
const AvailableVetCard = ({ user }) => {
  return (
    <div className="rounded overflow-hidden shadow border border-light border-1 rounded-3 bg-light-subtle card-custom" style={{width: "420px"}}>
      <img
        style={{ height: "320px" }}
        className="w-full p-4 img-responsive"
        src={
...
export { VetUpdateCard, VetCard, AvailableVetCard };
