...
@Module({
  imports:[MongooseModule.forFeature([{name: "ServicePlanBooking", schema: ServicePlanBookingSchema}]),
  MongooseModule.forFeature([{name: "User", schema: UserSchema}]),
  MongooseModule.forFeature([{name: "ServicePlan", schema: ServicePlanSchema}]),
